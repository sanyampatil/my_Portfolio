...
const Info = {
    name: "Sanyam Patil",
    stack: ["Software Engineer", "Full Stack Developer","Freelancer", "Open Source Contributor"],
...
const SkillInfo = [
    ...
    {
        title: "Backend",
        skills: ["Springboot", "Node JS", "Express JS", "MySQL", "MongoDB", "PostgresSQL"]
    },
    {
        title: "Languages",
    ...
    {
        title: "Tools",
        skills: ["Git", "Github", "VS Code", "Postman", "MongoDB Compass", "gcp","AWS"]
    }
]
const socialLinks = [
